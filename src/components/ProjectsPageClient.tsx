...
export default function ProjectsPageClient({ initialProjects }: ProjectsPageClientProps) {
  ...
  const categories = ["Tất Cả", ...Array.from(new Set(initialProjects.map((p) => p.category)))];
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8">
              ...
              <p className="font-body text-base text-ash max-w-md leading-relaxed">
                Nơi tụ hội của những dự án thiết kế nhận diện thương hiệu, hình ảnh sản phẩm F&B, video quảng cáo TVC chuyên nghiệp được thiết lập bởi HUGs STUDIO tại Đà Nẵng.
              </p>
            </div>
          </motion.div>
